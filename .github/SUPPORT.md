# Getting help with covid19nytimes

Thanks for using covid19nytimes. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/covid19nytimes/issues) to make sure the 
