...
Next, we need some county maps and state maps. For this, we'll use the excellent [tigris](https://cran.r-project.org/web/packages/tigris/index.html) package. We want the centroid of counties for bubble placement.
